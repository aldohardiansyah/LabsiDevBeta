            ...
            <div class="col-lg-12">
                <div class="card border-secondary mb-3">
                  ...
                  <div class="card-body">
                      ...
                      <form method="POST" action="{{ route('admin_jadwalasisten.insert2') }}" enctype="multipart/form-data">
                          @csrf
                        <fieldset>
                            <hr>
                            ...
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-2"></div>
                                <label for="staticEmail" class="col-sm-3 col-form-label"><strong>Asisten 3</strong></label>
                                <div class="col-sm-5">
                                    <select class="form-control selectdua" name="asisten3">
                                        <option value="" disabled selected>Pilih Asisten</option>
                                    @foreach ($asisten as $dataasisten4)
                            ...
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-2"></div>
                                <label for="staticEmail" class="col-sm-3 col-form-label"><strong>Asisten 4</strong></label>
                                <div class="col-sm-5">
                                    <select class="form-control selectdua" name="asisten4">
                                        <option value="" disabled selected>Pilih Asisten</option>
                                    @foreach ($asisten as $dataasisten5)
                                        <option value="{{$dataasisten5->id_asisten}}">{{$dataasisten5->nama_lengkap}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div><!--Busway Separator-->
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-2"></div>
                                <label for="staticEmail" class="col-sm-3 col-form-label"><strong>Asisten 5</strong></label>
                                <div class="col-sm-5">
                                    <select class="form-control selectdua" name="asisten5">
                                        <option value="" disabled selected>Pilih Asisten</option>
                                    @foreach ($asisten as $dataasisten6)
                                        <option value="{{$dataasisten6->id_asisten}}">{{$dataasisten6->nama_lengkap}}</option>
                                    @endforeach
                                    </select>
                                </div>
                            </div><!--Busway Separator-->

...
{{--
                            ...
                            <div class="form-group row"><!--Separator Busway-->
                                <div class="col-sm-1"></div>
                                <label for="staticEmail" class="col-sm-2 col-form-label"><strong> Aplikasi </strong></label>
                                <div class="col-sm-8">
                                    <input class="form-control" placeholder="Aplikasi yang digunakan"  name="aplikasi" required>
                                    <small id="fileHelp" class="form-text text-muted">Aplikasi yang digunakan pada praktikum ini</small>
                                </div>
                            </div><!--Busway Separator-->

          ...
          <div class="card mb-3">
              ...
              <div class="card-body row" >
                  ...
                  <div class="col-lg-4" align="center">
                      <p><a href="{{route('admin_asisten.cv', $data->npm )}}" class="btn btn-outline-primary  btn-xsm">Curriculum Vitae</a><p>
                  </div>
                  <div class="col-lg-4" align="center">
                      <p><a href="{{route('admin_asisten.cv', $data->npm )}}" class="btn btn-outline-primary  btn-xsm">Surat Lamaran</a><p>
                  </div>
                  <div class="col-lg-4" align="center">
                      <p><a href="{{route('admin_asisten.cv', $data->npm )}}" class="btn btn-outline-primary  btn-xsm">DNS Terakhir</a><p>
                  </div>
              </div>
            </div>

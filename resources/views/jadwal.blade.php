    ...
    <div class="container">
        <div class="row mt-4">
            ...
            <div class="col-lg-4">
                ...
                <hr>
                <form method="POST" action="{{ route('jadwal_search') }}" enctype="multipart/form-data">
                    @csrf
                    <center> <p> Semester Aktif : {{$semesteraktif->kode_semester}} </p> </center>
                    <input class="form-control mr-sm-2" type="text" name="kelas" placeholder="Cari Informasi">
